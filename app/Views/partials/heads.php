 ...
 <!-- Font Awesome -->
 <link rel="stylesheet" href="<?= base_url('plugins/adminlte') ?>/plugins/fontawesome-free/css/all.min.css">
 <!-- Ionicons -->
 <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
 <!-- Tempusdominus Bootstrap 4 -->
 <link rel="stylesheet" href="<?= base_url('plugins/adminlte') ?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
 <!-- iCheck -->
 <link rel="stylesheet" href="<?= base_url('plugins/adminlte') ?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
 <!-- JQVMap -->
 ...
 <!-- overlayScrollbars -->
 <link rel="stylesheet" href="<?= base_url('plugins/adminlte') ?>/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
 <!-- Daterange picker -->
